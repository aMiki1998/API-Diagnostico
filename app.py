...
app = FastAPI()
#(title="API de diagnóstico de covid 19",
#           description="test",
#           version="1.0.0")
...
data = pd.read_excel (r'C:\Users\Miky\Documents\Personales\Maestría\2022-1\Programación Avanzada\Proyecto\Datasets\Dataset 2\Datasetpequeño_Listo.xlsx') 
